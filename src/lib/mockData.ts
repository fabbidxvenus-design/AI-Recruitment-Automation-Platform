...
export const mockScreeningEvaluations: ScreeningEvaluation[] = [
  ...
  },
  {
    ...
    aiProvenance: {
      ...
      promptVersion: 'SCREEN-2026.05',
      confidence: 0.88,
      evaluatedAt: '2024-04-20T09:00:00Z',
    },
    overallScore: 79,
    decision: 'approve',
    aiSummary: 'Creative frontend developer with 3 years of experience. Strong design sensibility with Figma background complements her technical skills.',
    keyStrengths: [
      'Strong Vue.js and React skills',
      'GraphQL expertise',
      'Design-to-code workflow experience',
    ],
    concerns: [
  ...
  },
  {
    ...
    aiProvenance: {
      ...
      promptVersion: 'SCREEN-2026.05',
      confidence: 0.93,
      evaluatedAt: '2024-04-19T16:00:00Z',
    },
    overallScore: 88,
    decision: 'approve',
    aiSummary: 'Experienced Product Manager with 8 years in tech. Proven track record in Agile methodologies and data-driven decision making.',
    keyStrengths: [
      'Strong analytics and SQL skills',
  ...
  },
  {
    ...
    aiProvenance: {
      ...
      promptVersion: 'SCREEN-2026.05',
      confidence: 0.85,
      evaluatedAt: '2024-04-21T11:30:00Z',
    },
    overallScore: 81,
    decision: 'approve',
    aiSummary: 'Skilled Java backend developer with 5 years of experience in microservices architecture and Kubernetes orchestration.',
    keyStrengths: [
      'Expert in Spring Boot and microservices',
      'Strong Kubernetes orchestration skills',
      'Excellent distributed systems knowledge',
    ],
    concerns: [
      'Limited experience with cloud-native databases',
    ],
    evaluatedAt: '2024-04-21T11:30:00Z',
    status: 'pending',
  },
