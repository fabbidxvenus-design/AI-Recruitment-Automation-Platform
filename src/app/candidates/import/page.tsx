  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      if (!file.name.endsWith('.xlsx') && !file.name.endsWith('.xls')) {
        setValidationErrors([{ field: 'file', message: 'Please upload an Excel file (.xlsx or .xls)' }]);
        return;
      }
      setValidationErrors([]);
  ...
  return (
    <div className={styles.importPage}>
      <div className={styles.header}>
        <div>
          <h1 className={styles.title}>Candidate Sourcing & Import</h1>
          <p className={styles.description}>
            Import candidates from Excel, Google Drive, or add manually
          </p>
        </div>
        ...
        <div className={styles.blockersSection}>
          {bq002 && (
            <Notice variant="blocker" title={`${bq002.code}: ${bq002.title}`}>
              {bq002.description} <strong>Action required:</strong> {bq002.requiresAction}
            </Notice>
          )}
          {bq003 && (
            <Notice variant="blocker" title={`${bq003.code}: ${bq003.title}`}>
              {bq003.description} <strong>Action required:</strong> {bq003.requiresAction}
            </Notice>
          )}
        </div>
      )}
      ...
      <div className={styles.mainContent}>
        <div className={styles.importMethods}>
          <Card>
            <CardHeader title="Excel Upload" description="Import candidates from Excel spreadsheet" />
            <CardContent>
              <div className={styles.uploadArea}>
                <div className={styles.uploadIcon}>📁</div>
                <p className={styles.uploadText}>Drag and drop Excel file here</p>
                <p className={styles.uploadFormats}>Supported formats: .xlsx, .xls</p>
              ...
              {importStatus === 'processing' && (
                <div className={styles.processingState}>
                  ...
                  <span>Processing file and validating data...</span>
                </div>
              )}

              {importStatus === 'success' && (
                <div className={styles.successState}>
                  <StatusBadge variant="success" label="Import Successful" />
                  <p>12 candidates imported successfully</p>
                  <p className={styles.warning}>2 duplicates detected</p>
                  <Link href="/screening/review">
                    <Button variant="primary" size="sm">Review Imported Candidates</Button>
                  </Link>
                </div>
              )}
            </CardContent>
          ...
          <Card>
            <CardHeader title="Google Drive Import" description="Auto-import from configured Drive folder" />
            <CardContent>
              <div className={styles.driveSection}>
                <div className={styles.driveIcon}>📄</div>
                <Notice variant="warning" title="Drive Integration Required">
                  Connect Google Drive to enable automatic file imports. Files in the configured folder will be automatically imported.
                </Notice>
                <div className={styles.driveStatus}>
                  <span className={styles.driveLabel}>Watch Folder:</span>
                ...
                <div className={styles.driveStats}>
                  <div className={styles.driveStat}>
                    ...
                    <span className={styles.driveStatLabel}>Pending Files</span>
                  </div>
                  <div className={styles.driveStat}>
                    <span className={styles.driveStatValue}>0</span>
                    <span className={styles.driveStatLabel}>Last Import</span>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader title="Manual Entry" description="Add candidate details directly" />
            <CardContent>
              <form className={styles.manualForm} onSubmit={(e) => e.preventDefault()} aria-label="Manual candidate entry form">
                ...
                <div className={styles.formGroup}>
                  <label htmlFor="jobId" className={styles.formLabel}>Apply to Position *</label>
        ...
        <div className={styles.sidebar}>
          <Card>
            <CardHeader title="Recent Imports" description="Last 5 import sessions" />
            <CardContent>
              <div className={styles.recentImports}>
                <div className={styles.importItem}>
                  ...
                  <div className={styles.importDetails}>
                    ...
                    <span className={styles.importMeta}>12 candidates • Apr 20, 2024</span>
                  </div>
                ...
                <div className={styles.importItem}>
                  ...
                  <div className={styles.importDetails}>
                    ...
                    <span className={styles.importMeta}>8 candidates • Apr 18, 2024</span>
                  </div>
                  <StatusBadge variant="success" label="Complete" />
                </div>
                <div className={styles.importItem}>
                  ...
                  <div className={styles.importDetails}>
                    ...
                    <span className={styles.importMeta}>5 imported, 2 failed • Apr 15, 2024</span>
                  </div>
          ...
          <Card>
            <CardHeader title="Import Statistics" description="This month" />
            <CardContent>
              <div className={styles.statsList}>
                <div className={styles.statItem}>
                  <span className={styles.statValue}>47</span>
                  <span className={styles.statLabel}>Total Imported</span>
                </div>
                <div className={styles.statItem}>
        ...
        <div className={styles.modal} onClick={() => {}}>
          <div className={styles.modalContent} onClick={e => e.stopPropagation()}>
            <div className={styles.modalHeader}>
              <h2>Duplicate Candidates Detected</h2>
              <button
            ...
            <div className={styles.modalBody}>
              <p className={styles.duplicateInfo}>
                The following candidates already exist in the system. Choose how to handle each:
              </p>
            ...
            <div className={styles.modalFooter}>
              <Button variant="secondary" onClick={handleDismissDuplicates}>Cancel Import</Button>
              <Button variant="primary" onClick={handleDismissDuplicates}>Continue with Selection</Button>
            </div>
          </div>
        </div>
      )}
