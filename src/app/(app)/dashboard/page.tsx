    ...
    },
    {
      ...
      render: (row: typeof mockScreeningEvaluations[0]) => (
        <Link
          ...
          aria-label={t('dashboard.approvals.reviewAria', { candidate: row.candidateName, job: row.jobTitle })}
        >
          {t('dashboard.approvals.review')}
        </Link>
      ),
    },
  ];
                ...
                {mockIntegrationHealth.map(integration => (
                  <div key={integration.id} className={styles.integrationItem}>
                    <div className={styles.integrationStatus}>
                      <span className={`${styles.statusDot} ${styles[integration.status]}`} aria-label={t('dashboard.sourceConfig.statusDot', { status: integration.status })} />
            ...
            <CardContent>
              <div className={styles.activityFeed}>
                <div className={styles.activityItem}>
                  <span className={styles.activityIcon} role="img" aria-label={t('dashboard.activity.movedToStage', { name: 'Sarah Chen', stage: 'Interview' })}>✅</span>
                ...
                <div className={styles.activityItem}>
                  <span className={styles.activityIcon} role="img" aria-label={t('dashboard.activity.awaitingScreening', { count: 3 })}>📋</span>
                  <div className={styles.activityContent}>
                ...
                <div className={styles.activityItem}>
                  <span className={styles.activityIcon} role="img" aria-label={t('dashboard.activity.scheduledInterview', { name: 'Emily Williams' })}>📅</span>
                  <div className={styles.activityContent}>
                ...
                <div className={styles.activityItem}>
                  <span className={styles.activityIcon} role="img" aria-label={t('dashboard.activity.videoError')}>⚠️</span>
                  <div className={styles.activityContent}>
